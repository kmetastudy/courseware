# Generated by Django 4.1.5 on 2023-12-01 02:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('_main', '0004_order_orderedproduct_order_product_set'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('ready', '결제 준비'), ('paid', '결제 완료'), ('canceled', '결제 취소'), ('failed', '결제 실패')], default='ready', max_length=20, verbose_name='결제상태')),
