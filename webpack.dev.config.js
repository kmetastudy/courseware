...
var configCP = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: `cp-bundle-20240726.js`,
    libraryTarget: "var",
    clean: true,
  ...
  plugins: [
    new MiniCssExtractPlugin({
      ...
      filename: `cp-bundle-20240726.css`,
    }),
  ],
});
...
var configST = Object.assign({}, config, {
  ...
  output: {
    ...
    library: "stlibrary",
    filename: "st-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "st-bundle-20240726.css",
    }),
  ],
...
var configSTSchool = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "st-school-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "st-school-bundle-20240726.css",
    }),
  ],
});
...
var configSchool = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "school-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "school-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configUser = Object.assign({}, config, {
  ...
  output: {
    ...
    library: "userlibrary",
    filename: "user-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "user-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configMain = Object.assign({}, config, {
  ...
  output: {
    ...
    library: "mainlibrary",
    filename: "main-bundle-20240726.js",
    libraryTarget: "var",
    // clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "main-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configCM = Object.assign({}, config, {
  ...
  output: {
    ...
    library: "cmlibrary",
    filename: "cm-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "cm-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configDashboard = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "dashboard-bundle-20240726.js",
    libraryTarget: "var",
    // clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "dashboard-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configStats = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "stats-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "stats-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configStatsDetail = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "stats-detail-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "stats-detail-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configClass = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "class-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "class-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configClassLaunch = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "class_launch-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
    // assetModuleFilename: '[name][ext]',
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "class_launch-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configClassRoomTeacher = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: "classroom-teacher-bundle-20240726.js",
    libraryTarget: "var",
    clean: true,
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: "classroom-teacher-bundle-20240726.css",
    }),
  ],
  module: tailwindModuleConfig,
});
...
var configClassroomStudent = Object.assign({}, config, {
  ...
  output: {
    ...
    filename: `classroom-student-bundle-20240726.js`,
    libraryTarget: "var",
    clean: true,
  },
  plugins: [
    new MiniCssExtractPlugin({
      filename: `classroom-student-bundle-20240726.css`,
    }),
  ],
  module: tailwindModuleConfig,
});
