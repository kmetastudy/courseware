const CourseSwiperCard = (courses) => {
    ...
    if(splitedPath.includes('school')) startURL = '.'
        ...
        ${courses.map((course, index) => {
            ...
            return `
            <div class="swiper-slide card card-compact h-auto bg-base-100 shadow-xl cursor-pointer" onclick="window.location='${startURL}/courses/${course.course.school}/${course.course.subject}/${course.id}'">
