const Category = (sections) => {
        ...
        return `
            <div data-component="category" class="categoryMobile px-5 flex justify-between text-[#474747] font-normal text-center" style="margin-top:20px; margin-bottom: 40px;">
