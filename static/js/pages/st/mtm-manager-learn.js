...
import { mtmStudyContainer } from "./study/mtm-study-container.js";
import { mtmStudyBuilder } from "./study/mtm-study-builder.js";
...
mtmManagerLearn.id = 0;

mtmManagerLearn.prototype._initEvents = function () {
...
mtmManagerLearn.prototype._init = function () {
  ...
  this.clStudyBuilder = new mtmStudyBuilder();
  this.clRightTab.appendPanel(0, this.clStudyBuilder.elThis);

  this.clStatBuilder = new mtmStatBuilder();
  // 통계는 아직
  // this.clRightTab.appendPanel(1,this.clStatBuilder.elThis);
...
mtmManagerLearn.prototype._makeOnePanel = function () {
...
mtmManagerLearn.prototype._makeTwoPanel = function () {
 ...
 */
mtmManagerLearn.prototype.onResizeWindowHandler = function () {
  this._arrangePanelLayout();
};
 ...
 */
mtmManagerLearn.prototype.onLeftTabActivate = function (index) {
  // console.log('mtmManagerLearn > onLeftTabActivate : ',index);
 ...
 * function :
 */
mtmManagerLearn.prototype.onRightTabActivate = function (index) {
  // console.log('mtmManagerLearn > onLeftTabActivate : ',index);
};
