...
mtmPlayerLessonResultTable.prototype.addIconTitleFormatter = function (column, param2, param3) {
  //plain text value
...
mtmPlayerLessonResultTable.prototype.addIconFormatter = function (cell, formatterParams) {
  //plain text value
  // cell.get
  // return "<i class='fa fa-plus'></i>";
  return;
...
mtmPlayerLessonResultTable.prototype.d3PointFormatter = function (cell, formatterParams, onRendered) {
  //plain text value
  // d3Formatter
...
mtmPlayerLessonResultTable.prototype.d3PrintPointFormatter = function (cell, formatterParams, onRendered) {
  //plain text value
  // d3Formatter
...
mtmPlayerLessonResultTable.prototype.d3PercentFormatter = function (cell, formatterParams, onRendered) {
  //plain text value
  // d3Formatter
...
mtmPlayerLessonResultTable.prototype.d3PrintPercentFormatter = function (cell, formatterParams, onRendered) {
  //plain text value
  // d3Formatter
...
mtmPlayerLessonResultTable.prototype.blankFormatter = function (cell, formatterParams, onRendered) {
  //plain text value
  // blankFormatter
  return "";
};
...
mtmPlayerLessonResultTable.prototype.cellClick = function (e, cell) {
  ...
  // setTimeout ???
  if (this.options && this.options.eventCellClick) this.options.eventCellClick(column_no, parseInt(row_no) - 1, value);
