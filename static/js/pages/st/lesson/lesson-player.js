...
export var LessonPlayer = function (options) {
...
LessonPlayer.id = 0;
LessonPlayer.UnitMaxQNum = 3;

LessonPlayer.prototype._createLessonTitle = function (parent) {
  var options = {};
  options.title = "레슨 제목";
...
LessonPlayer.prototype._createLessonProgress = function (parent) {
  var options = {};
  options.items = [];
...
LessonPlayer.prototype._createLessonPopUp = function (parent) {
  var options = {};
  this.clMessagePopUp = new mtmStudyMessagePopup(options);
  parent.appendChild(this.clMessagePopUp.elThis);
};

LessonPlayer.prototype._createLessonSubmitAction = function (parent) {
  var options = {};
  options.items = [
    {
      enable: true,
...
LessonPlayer.prototype._createLessonResultTable = function (parent) {
  // 레슨 결과 테이블
  var options = {};
...
LessonPlayer.prototype._createLessonQuestion = function (parent) {
  // 레슨 문제 플레이어
  var options = {};
...
LessonPlayer.prototype._createLessonVideo = function (videoId, videoTime) {
  var options = {};
...
LessonPlayer.prototype._init = function () {
...
LessonPlayer.prototype._getContentPairIndex = function (index) {
...
LessonPlayer.prototype._getContentLinearIndex = function (unitIndex, itemIndex) {
  var num = 0;
  //
...
LessonPlayer.prototype._checkProgressPoint = function () {
...
LessonPlayer.prototype._showPlayer = function (bShow) {
  if (bShow) {
...
////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////
LessonPlayer.prototype._updateLessonResult = function (bCorrect) {
...
// 2)
LessonPlayer.prototype._prepareResult = function () {
...
LessonPlayer.prototype._prepareTitle = function (title) {
  this.clPlayerLessonTitle.setTitle(title);
};

LessonPlayer.prototype._prepareProgress = function () {
...
LessonPlayer.prototype._wrongStep = function () {
...
LessonPlayer.prototype._continueStep = function () {
...
LessonPlayer.prototype._correctStep = function () {
  // Study Result Update 조정
...
LessonPlayer.prototype._questionSubmitLesson = function () {
  //
...
LessonPlayer.prototype._videoContinueLesson = function () {
...
LessonPlayer.prototype._startVideo = function () {
...
LessonPlayer.prototype._beforeStartQuestion = function () {
  // Hide Others
  if (this.clPlayerVideoContent) this.clPlayerVideoContent.show(false);
  this.clLessonResultTable.show(false);
  this.clLessonSubmitAction.show(false);
...
LessonPlayer.prototype._startQuestion = function () {
...
LessonPlayer.prototype._playLessonContent = function () {
...
////////////////////////////////////////////////////////////////////////
/////////////////////////////// Handler ////////////////////////////////
LessonPlayer.prototype.onOnePanelHandler = function () {
  console.log("LessonPlayer > onOnePanelHandler");
  // this.elExitButton.style.display = '';
};

LessonPlayer.prototype.onTwoPanelHandler = function () {
  console.log("LessonPlayer > onTwoPanelHandler");
  // this.elExitButton.style.display = 'none';
};

// 현재 안씀 - 테스트 용
LessonPlayer.prototype.onStepDownHandler = function () {
  this.clPlayerLessonProgress.stepDown();
};
// 현재 안씀 - 테스트 용
LessonPlayer.prototype.onStepUpHandler = function () {
  this.clPlayerLessonProgress.stepUp();
};
// 현재 안씀 - 테스트 용
LessonPlayer.prototype.onMessagePopUpHandler = function () {
...
LessonPlayer.prototype.onExitHandler = function () {
  console.log("LessonPlayer : onExitHandler");
...
LessonPlayer.prototype.onVideoCompleted = function () {
  ...
  if (this.clPlayerVideoContent && this.clPlayerVideoContent.bShow) setTimeout(this._videoContinueLesson.bind(this), 0);
  else console.log("LessonPlayer : onVideoCompleted --- abnormal");
};

// Question Card 에서 "제출" 버튼
// 문제의 답을 제출 했을때...
LessonPlayer.prototype.onQuestionSubmitHandler = function () {
  setTimeout(this._questionSubmitLesson.bind(this), 0);
};

// Question Card 에서 "오답하기" 버튼
LessonPlayer.prototype.onCorrectWrongHandler = function () {
  // console.log('LessonPlayer : onCorrectWrongHandler');
  this._playLessonContent();
};

LessonPlayer.prototype.onContinueContentHandler = function () {
  // 이어하기가 가능 하면...
...
LessonPlayer.prototype.onConfirmContentHandler = function () {};

LessonPlayer.prototype.onNextStepHandler = function () {
  console.log("LessonPlayer > onNextStepHandler : ");
  this._continueStep();
};

LessonPlayer.prototype.onConfirmHandler = function () {
...
LessonPlayer.prototype.onEventSolutionHandler = function (eData) {
...
LessonPlayer.prototype.onUnseenVideoClickHandler = function (tX, tY, value) {
...
LessonPlayer.prototype.onCellClickHandler = function (tX, tY, value) {
...
////////////////////////////////////////////////////////////////////////
////////////////////////////////// API /////////////////////////////////
LessonPlayer.prototype.setPlayOptions = function (options) {
...
LessonPlayer.prototype.startLesson = function () {
  this.player.bSolutionPlay = false;
...
LessonPlayer.prototype.show = function (bShow) {
  if (bShow) this.elThis.style.display = "block";
  else this.elThis.style.display = "none";
};

LessonPlayer.prototype.stopLesson = function () {
  //
  this.player.bSolutionPlay = false;
...
LessonPlayer.prototype.removePlayerVideo = function () {
...
// 기능이 없네....
LessonPlayer.prototype.requestPlayerVideo = function () {
  if (this.options && this.options.requestPlayerVideo) return this.options.requestPlayerVideo();

  return null;
};

LessonPlayer.prototype.setOptionInfo = function (data) {
...
////////////////////////////////////////////////////////////////////////
///////////////////////////////// URL //////////////////////////////////
LessonPlayer.prototype._aurlUpdateLessonResultInfo = function (result) {
  if (!this.options.modeStudent)
    // no student
    this.options.onSkipContent = false;
};

LessonPlayer.prototype._urlUpdateLessonResultInfo = function () {
  var self = this;
