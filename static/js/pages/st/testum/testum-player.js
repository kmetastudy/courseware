...
export class TestumPlayer {
  ...
  _createGradeButton(parent) {
    ...
    const elText = createElement("i", {
      className: classNames("fa-solid", "fa-check"),
      text: "채점",
    });
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////// URL /////////////////////////////////////////
  _aurlUpdateTestumResultInfo(result) {}
  _urlUpdateTestumResultInfo(data) {
    var self = this;
