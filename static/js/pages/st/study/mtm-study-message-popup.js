...
export class mtmStudyMessagePopup {
  constructor(options) {
  ...
  _create(tagList) {
    ...
    topElement.classList.add("mtm-study-message-popup-container");
      ...
      for (var i = 0; i < tagList.length; i++) {
        if (tagList[i]["comp"]) {
          if (tagList[i]["comp"] == "title-area") {
            ...
            element = this.elMessageItself = mtvElementBuilder.createComponent(
...
mtmStudyMessagePopup.staticTitleItself = [
  {
    level: 0,
    tag: "div",
    class: "mtm-study-message-popup-card-body-title",
...
mtmStudyMessagePopup.staticMessageItself = [
  { level: 0, tag: "div", class: "mtm-study-message-popup-card-body-message", attr: { style: "min-height:200px" } },
  {
    level: 1,
    tag: "div",
...
mtmStudyMessagePopup.staticBody = [
  {
    level: 0,
    tag: "div",
    class: "mtv-testum-card-normal mtm-study-message-popup-card",
    attr: { "data-index": "", "data-uid": "", style: "width:460px" },
  },

  { level: 1, tag: "div", class: "mtv-testum-card-normal-body card-body mtm-study-message-popup-card-body" },
  // 제목 영역
  // {'level':2,'comp':'title-area',},
  { level: 2, comp: "title-itself" },
  { level: 2, tag: "hr", class: "mtm-study-message-popup-card-divider" },
