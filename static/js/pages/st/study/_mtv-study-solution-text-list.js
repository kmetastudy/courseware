...
require("../../../../css/mtv/st/study/mtv-study-solution-text-list.css");

export var mtvStudySolutionTextList = function (options) {
  this.id = "mtv-study-solution-text-list-" + mtvStudySolutionTextList.id++;
...
mtvStudySolutionTextList.prototype._create = function () {
  this.elCompList = mtvElementBuilder.buildComponent(mtvStudySolutionTextList.staticBody, true);
  // Component List Matching
  this.elThis = this.elCompList[0];
};

mtvStudySolutionTextList.prototype._matchElements = function () {
  for (var i = 0; i < this.elsArray.length; i++) {
    if (this.elsArray[i]) this.elsObject[this.elsArray[i]] = this.elCompList[i];
  }
};

mtvStudySolutionTextList.prototype._prepareOptions = function () {
  if (this.options.no) {
...
mtvStudySolutionTextList.prototype._initEvents = function () {
  this.elsObject.elHeader.addEventListener("click", this._onClickHandler.bind(this));
};

mtvStudySolutionTextList.prototype._init = function () {
  this._create();
  this._matchElements();
...
/////////////////////////////////// Event Handler //////////////////////////////////
mtvStudySolutionTextList.prototype._onClickHandler = function (e) {
...
/////////////////////////////////// API //////////////////////////////////
mtvStudySolutionTextList.prototype.toggleContent = function (e) {
  ...
  if (this.elsObject.elThis.classList.contains("hidden")) {
    ...
    console.log("mtvStudySolutionTextList > toggleContent: ", this.elsObject.elContent.offsetHeight);
