...
require("../../../../css/mtv/st/study/mtv-study-solution-video-list.css");

export var mtvStudySolutionVideoList = function (options) {
  this.id = "mtv-study-solution-video-list-" + mtvStudySolutionVideoList.id++;
...
mtvStudySolutionVideoList.id = 0;

mtvStudySolutionVideoList.staticPreUrl = ["https://i.ytimg.com/vi/", "https://"];

mtvStudySolutionVideoList.staticPostUrl = ["/hqdefault.jpg"];

// 헤더 영역
// {'level':0,'comp':'number-area',},
//     {'level':1, 'comp':'number-itself',},
// {'level':0,'tag':'hr','class':'mt-1'},
mtvStudySolutionVideoList.areaHeader = [
...
mtvStudySolutionVideoList.areaBody = [
  { step: 0, tag: "div", class: "px-0 py-0 my-0", attr: { style: "overflow-y:hidden; overflow-x:hidden;" } },
...
mtvStudySolutionVideoList.staticBody = [
...
mtvStudySolutionVideoList.prototype._create = function () {
  this.elCompList = mtvElementBuilder.buildComponent(mtvStudySolutionVideoList.staticBody, true);
...
mtvStudySolutionVideoList.prototype._matchElements = function () {
  for (var i = 0; i < this.elsArray.length; i++) {
    if (this.elsArray[i]) this.elsObject[this.elsArray[i]] = this.elCompList[i];
  }
};

mtvStudySolutionVideoList.prototype._prepareOptions = function () {
  var src = mtvStudySolutionVideoList.staticPreUrl[0] + this.options.url + mtvStudySolutionVideoList.staticPostUrl[0];
...
mtvStudySolutionVideoList.prototype._initEvents = function () {
  this.elThis.addEventListener("click", this._onClickHandler.bind(this));
  // this.elThis.style.cursor = "pointer";
};

mtvStudySolutionVideoList.prototype._init = function () {
  this._create();
  this._matchElements();
...
/////////////////////////////////// Event Handler //////////////////////////////////
mtvStudySolutionVideoList.prototype._onClickHandler = function (e) {
  var eData = {};
...
/////////////////////////////////////// API ////////////////////////////////////
mtvStudySolutionVideoList.prototype.setVideoData = function (data) {
...
mtvStudySolutionVideoList.prototype.setVideoId = function (videoId) {
