...
export class MtmNav {
  ...
  createMenu(data, i) {
    ...
    const menu3 = $(`<svg class="star${i+1}" width="84" height="48" viewBox="0 0 84 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="12" y="6" width="72" height="36" rx="10" fill="#${data.color}"/>
