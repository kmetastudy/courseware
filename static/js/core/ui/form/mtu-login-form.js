...
require("../../../../css/core/ui/form/mtu-login-form.css");
export const mtuLoginForm = function (options) {
  this.options = options;
  this._init();
};

mtuLoginForm.prototype._init = function () {
  this._create();
  this._initEvents();
};

mtuLoginForm.prototype._create = function () {
  ...
  // remember me?
  this.forgetWrapper = document.createElement("div");
  this.forgetWrapper.classList.add("flex-row");
  this.elThis.appendChild(this.forgetWrapper);

  const container = document.createElement("div");
  this.forgetWrapper.appendChild(container);

  this.elRadio = document.createElement("input");
  this.elRadio.setAttribute("type", "radio");
  container.appendChild(this.elRadio);

  this.rememberLabel = document.createElement("label");
  this.rememberLabel.textContent = "Remember me";
  container.appendChild(this.rememberLabel);
  // Forgot password?
  this.elForgot = document.createElement("span");
  this.elForgot.classList.add("span");
  this.elForgot.textContent = "Forgot password?";
  this.forgetWrapper.appendChild(this.elForgot);

  // Sign in
  this.elSubmit = document.createElement("button");
  this.elSubmit.classList.add("button-submit");
  this.elSubmit.textContent = "Sign in";
  this.elThis.appendChild(this.elSubmit);

  // Sign up
  this.elSignup = document.createElement("p");
  this.elSignup.classList.add("p");
  this.elSignup.classList.add("lines");
  this.elSignup.textContent = "Dont' have an account? ";
  this.elThis.appendChild(this.elSignup);

  this.elSignupText = document.createElement("span");
  this.elSignupText.classList.add("span");
  this.elSignupText.textContent = "Sign Up";
  this.elSignup.appendChild(this.elSignupText);
};

mtuLoginForm.prototype._initEvents = function () {
  this.elThis.addEventListener("submit", this.handleSubmit.bind(this));
};

mtuLoginForm.prototype.handleSubmit = function (event) {
...
// TODO
// dynamic
mtuLoginForm.prototype._initVariable = function () {
  this.defaultItem = [
