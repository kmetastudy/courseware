...
// var mtmInputVideoTime = (function()
// {
//     var constants = {
...
require('./mtm-input-video-time.css');

export var mtmInputVideoTime = function(parentId,elParent,options) {
    ...
    this.hourEl.readOnly = this.readOnly;
    ...
    this.minuteEl.readOnly = this.readOnly;
    ...
    this.secondEl.readOnly = this.readOnly;
