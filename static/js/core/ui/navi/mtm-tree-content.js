...
export var mtmTreeContent = function(options)
{
    this.id = 'id-mtm-tree-content-' + mtmTreeContent.id++;
...
// mtmTreeContent.prototype._addInputDate = function() 
// {
//     var options = {};
//     options.title = "시작일";
//     options.width = "50%";
...
mtmTreeContent.prototype._addTreeItem = function(item) 
{
    var listItem = new mtmListItem(item);
    this.elWrapper.appendChild(listItem.elThis);
}

mtmTreeContent.prototype._setTreeList = function() {
...
mtmTreeContent.prototype._init = function() {
    this.elThis = document.createElement('div');
    this.elThis.classList.add('mtm-tree-content');
    ...
    // this._addInputDate();
    // for test
    // this.options.treeList = mtmTreeContent.testData;
    // this._setTreeList();
...
mtmTreeContent.prototype._fixLowLevel = function() {
...
mtmTreeContent.prototype._releaseLowLevel = function() {
    this.fixLowLevel = false;
    for(var i=0;i<this.itemList.length;i++)
    {
        if(this.itemList[i].level > 1)
...
mtmTreeContent.prototype._findIndex = function(uuid) {
    var currentIdx = -1;
    // console.log('mtmTreeContent > onRemoveHandler uuid:',uuid);
    for(var i=0;i<this.itemList.length;i++)
    {
...
mtmTreeContent.prototype._freezeLevel = function(level) {
    // 
    var index = -1;
    for(var i=0;i<this.itemList.length;i++)
    {
...
mtmTreeContent.prototype._releaseLevel = function(level) {
    for(var i=0;i<this.itemList.length;i++)
    {
        if(this.itemList[i].level == level)
        {
...
mtmTreeContent.prototype._changeItem = function(level) {
    ...
    // console.log("mtmTreeContent > _changeItem index : ",startIndex, " , 갯수 : ", endIndex - startIndex + 1);
    ...
    // console.log("mtmTreeContent > _changeItem List : ", itemList);
    ...
    // console.log('mtmTreeContent > _changeItem (itemList): ', findIndex , itemList );
    for(var i=0;i<itemList.length;i++)
    {
        this.itemList.splice(i+findIndex,0,itemList[i]);
    }

    console.log('mtmTreeContent > _changeItem (this.itemList) : ', this.itemList);
...
mtmTreeContent.prototype.dragStartHandler = function(_,ui)
{
    ...
    console.log('mtmTreeContent > dragStartHandler : start : ', this.originalLevel,
...
mtmTreeContent.prototype.dragSortHandler = function(_,ui)
{
    // console.log('mtmTreeContent > dragSortHandler : start : ',ui);
    return;
    
}

mtmTreeContent.prototype.dragChangeHandler = function(_,ui)
{
    console.log('mtmTreeContent > dragChangeHandler ');
    return;
}

mtmTreeContent.prototype.dragStopHandler = function(_,ui)
{
    console.log('mtmTreeContent > dragStopHandler : ',this.originalIndex, ui.item.index());
...
mtmTreeContent.prototype.dragBeforeStop = function(event, ui) {
    // if(ui.placeholder.index() == 2) 
    console.log('mtmTreeContent > beforeStop : ', ui.placeholder.index());
    // return false;
}

// click or select ??
mtmTreeContent.prototype.onBranchClickHandler = function() {

}

// title ?
mtmTreeContent.prototype.onBranchChangeTitleHandler = function() {

}

// order ?
mtmTreeContent.prototype.onBranchChangeOrderHandler = function() {

}

////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////// Action Handler ////////////////////////////////////
mtmTreeContent.prototype.onAddHandler = function(clItem, uuid,index, actionIndex) {
    var currentIdx = -1;
    // console.log('mtmTreeContent > onAddHandler uuid:',uuid);
    for(var i=0;i<this.itemList.length;i++)
    {
        if(this.itemList[i].uuid ==  uuid)
        {
    ...
    if(currentIdx < 0)
        return;
    // console.log('mtmTreeContent > onAddHandler currentIdx :',currentIdx);
    // if(clItem.level)
    var action = {};
    var eventHandler = {};
    eventHandler.add = this.onAddHandler.bind(this);
...
mtmTreeContent.prototype.onRemoveHandler = function(clItem, uuid,index) {
    var currentIdx = -1;
    // console.log('mtmTreeContent > onRemoveHandler uuid:',uuid);
    for(var i=0;i<this.itemList.length;i++)
    {
    ...
    // console.log('mtmTreeContent > onRemoveHandler :', this.itemList, 
...
mtmTreeContent.prototype.onToggleHandler = function(clItem, uuid,index,checked) {
    // console.log('mtmTreeContent > onToggleHandler');
    ...
    {
        // console.log('mtmTreeContent > onToggleHandler : ', currentIdx);
...
mtmTreeContent.prototype.onClickHandler = function(clItem, uuid,index) {
    var currentIdx = this._findIndex(uuid)
    // console.log('mtmTreeContent > onClickHandler level :',clItem.level);
    ...
    {
        // console.log('mtmTreeContent > onClickHandler idx :',currentIdx);
        for(var i=0;i<this.itemList.length;i++)
        {
            if(i==currentIdx)
...
////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////// API ///////////////////////////////////////////
mtmTreeContent.prototype.collapse = function(bCollapse)
{
    // if(bCollapse)
    // {
    ...
    // else
    // {
    //     this.elThis.style.height = parseInt(this.elWrapper.offsetHeight) + 'px';
    // }
}

mtmTreeContent.prototype.show = function(bShow)
{
    if(bShow)
...
mtmTreeContent.prototype.setActionable = function(bActionable)
{
...
mtmTreeContent.prototype.setAssignable = function(bAssign)
{
...
mtmTreeContent.prototype.setAssignToggle = function(bAssignToggle)
{
...
mtmTreeContent.prototype.setTreeList = function(treeList)
{
    // delete previous 
    for(var i=0;i<this.itemList.length;i++)
    {
